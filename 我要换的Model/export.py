...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3-tiny.pt', help='weights path')  # from yolov5/models/
    ...
    torch.onnx.export(
        model, img, f,
        verbose=False,
        opset_version=12,  # 保守：降低到 12
        input_names=['input'],
        output_names=['output'],
        dynamic_axes=None  # 关键：禁用动态轴，固定维度
    )
